...
//                   {user?.user?.email === "lakhan123@gmail.com" ? <div className="flow-root">
...
//                         // src="https://th.bing.com/th?id=OIF.cFvCnTCBQezZfcTBPZ%2bbQQ&w=312&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7"
//                            src="../../.././sunder.jpg"
//                         alt="Sunder_Pichai" />                                      
//                   </Link>
//                   </div>
...
//                   <div className="flex ">
//                     <h1 className=' text-2xl font-bold text-black  px-2 py-1 rounded text-orange-600' style={{ color: mode === 'dark' ? 'white' : '', }}>E-Bharat</h1>
//                   </div>
//                 </Link>
//               </div>
...
//                     Order
//                   </Link> : ""}
//                   {user?.user?.email ==='lakhan123@gmail.com' ?  <Link to={'/dashboard'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
//                     Admin
//                   </Link> : ""}
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                 ...
                 {user ?  <Link to={'/order'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                  ...
                  {user?.user?.email === 'lakhan123@gmail.com' ? 
